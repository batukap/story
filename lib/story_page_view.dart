...
class StoryPageView extends StatefulWidget {
  ...
  /// story değiştirği zaman çalışacak fonksiyon
  final void Function(bool)? onStoryChanged;

  /// story değiştirği zaman çalışacak fonksiyon
  final void Function()? storyLongPress;

  /// story değiştirği zaman çalışacak fonksiyon
  final void Function()? storyLongPressUp;
            ...
            child: Stack(
              children: [
                _StoryPageBuilder.wrapped(
                  ...
                  storyLongPress: widget.storyLongPress,
                  storyLongPressUp: widget.storyLongPressUp,
                ),
...
class _StoryPageBuilder extends StatefulWidget {
  const _StoryPageBuilder._({
    ...
    required this.storyLongPress,
    required this.storyLongPressUp,
  }) : super(key: key);
  ...
  static Widget wrapped({
    ...
    required void Function(bool)? onStoryChanged,
    required void Function()? storyLongPress,
    required void Function()? storyLongPressUp,
  }) {
    return MultiProvider(
          ...
          create: (_context) => _StoryStackController(
            ...
            onPageForward: () {
              if (pageIndex == pageLength - 1) {
                _context.read<_StoryLimitController>().onPageLimitReached(onPageLimitReached);
              } else {
                animateToPage(pageIndex + 1);
              }
            },
      ...
      child: _StoryPageBuilder._(
        ...
        storyLongPress: storyLongPress,
        storyLongPressUp: storyLongPressUp,
      ),
    );
  }
...
class _StoryPageBuilderState extends State<_StoryPageBuilder> with AutomaticKeepAliveClientMixin<_StoryPageBuilder>, SingleTickerProviderStateMixin {
      ...
      duration: widget.indicatorDuration,
        ...
        (status) {
          if (status == AnimationStatus.completed) {
            context.read<_StoryStackController>().increment(restartAnimation: () => animationController.forward(from: 0));
          }
        },
      );
            ...
            child: GestureDetector(
              onTap: () {
                if (onStoryChanged != null) {
                  onStoryChanged?.call(false);
                }
                animationController!.forward(from: 0);
                context.read<_StoryStackController>().decrement();
              },
              onLongPress: () {
                if (storyLongPress != null) {
                  storyLongPress?.call();
                }
                animationController!.stop();
              },
              onLongPressUp: () {
                if (storyLongPressUp != null) {
                  storyLongPressUp?.call();
                }
                if (storyImageLoadingController.value != StoryImageLoadingState.loading) {
                  animationController!.forward();
                }
...
class _IndicatorsState extends State<_Indicators> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isCurrentPage && !widget.animationController!.isAnimating && !isStoryEnded && storyImageLoadingController.value != StoryImageLoadingState.loading) {
